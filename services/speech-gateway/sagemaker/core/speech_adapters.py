...
from speech_normalization import extract_entities, normalize_text, requires_confirmation
...
class CTranslate2ASRAdapter(ASRAdapter):
    ...
    def __init__(self, model_id: str, device: str = "cpu", compute_type: str = "int8"):
        self.model_id = model_id
        self.model_version = "pinned-by-model-id"
        self.device = device
